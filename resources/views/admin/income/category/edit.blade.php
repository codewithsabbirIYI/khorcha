                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-8 card_title_part">
                                <i class="fab fa-gg-circle"></i>Update Income Category
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-7">
                                ...
                                <input type="hidden" value="{{$data->incate_id}}" name="id">

                                <input type="text" class="form-control form_control @error('name') is-invalid @enderror" id="" name="name" value="@if ($data->incate_name){{$data->incate_name}}@else{{old('name')}}@endif">
